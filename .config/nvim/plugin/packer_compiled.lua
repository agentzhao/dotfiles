...
_G.packer_plugins = {
  ...
  ["nvim-ufo"] = {
    loaded = true,
    path = "/home/zhao/.local/share/nvim/site/pack/packer/start/nvim-ufo",
  ...
  ["promise-async"] = {
    loaded = true,
    path = "/home/zhao/.local/share/nvim/site/pack/packer/start/promise-async",
